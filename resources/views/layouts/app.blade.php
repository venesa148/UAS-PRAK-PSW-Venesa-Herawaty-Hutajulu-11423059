...
{{--  
            ...
            <div class="flex items-center">
                ...
                <button data-dropdown class="flex items-center px-3 py-2 focus:outline-none hover:bg-gray-200 hover:rounded-md" type="button" x-data="{ open: false }" @click="open = true" :class="{ 'bg-yellow-200 rounded-md': open }">
                    ...
                    <span class="ml-4 text-sm hidden md:inline-block">Sport For Life</span>
            ...
            <div class="sidebar text-center bg-blue-500">
                <div class="text-gray-100 text-xl">
                    <div class="p-2.5 mt-1 flex items-center">
                        ...
                        <h1 class="font-bold text-gray-200 text-[15px] ml-3">Pengelola Lapangan</h1>
                    </div>
                </div>
                ...
                <a href="{{ route('admin/products') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        ...
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">CRUD Product</span>
                    </div>
                </a>
                {{-- Tambahan --}}
                <a href="{{ route('admin/court/admin') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">CRUD Court</span>
                    </div>
                </a>
                <a href="{{ route('abooking') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">CRUD Booking</span>
                    </div>
                </a>
                <a href="{{ route('member') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                ...
                <a href="{{ route('databerita') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[11px] ml-4 text-gray-200 font-bold">CRUD Pengumuman</span>
                    </div>
                </a>
