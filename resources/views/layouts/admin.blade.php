...
{{--  
            ...
            <div class="flex items-center">
                ...
                <button data-dropdown class="flex items-center px-3 py-2 focus:outline-none hover:bg-gray-200 hover:rounded-md" type="button" x-data="{ open: false }" @click="open = true" :class="{ 'bg-yellow-200 rounded-md': open }">
                    <img src="https://karirlab-prod-bucket.s3.ap-southeast-1.amazonaws.com/files/privates/2d4FVPFQFQBvcuf7lwKzEOxiTH0M8mWOnY1Bthr2.png" alt="Profle" class="h-8 w-8 rounded-full">
 
                    <span class="ml-4 text-sm hidden md:inline-block">IT Del Sport</span>
                    ...
                    <div data-dropdown-items class="text-sm text-left absolute top-0 right-0 mt-16 mr-4 bg-white rounded border border-gray-400 shadow" x-show="open" @click.away="open = false">
                        <ul>
                            <li class="px-4 py-3 border-b hover:bg-gray-200"><a href="#">Profile</a></li>
    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-64 h-screen overflow-y-auto bg-blue-500 border-r rtl:border-r-0 rtl:border-l dark:bg-blue-500 dark:border-gray-700">
            <div class="sidebar text-center bg-blue-500">
                <div class="text-gray-100 text-xl">
                    <div class="p-2.5 mt-1 flex items-center">
                        {{-- <i class="bi bi-app-indicator px-2 py-1 rounded-md bg-blue-600"></i> --}}
                        <h1 class="font-bold text-gray-200 text-[15px] ml-3">Admin Pemilik</h1>
                    </div>
                </div>
                {{-- <a href="{{ route('admin/home') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                ...
                <a href="{{ route('lokasi') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">CRUD Lokasi</span>
                    </div>
                </a>
                ...
                <a href="{{ route('lapangan') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">CRUD Lapangan</span>
                    </div>
                </a>
                <a href="{{ route('admin/court') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold"> Court List</span>
                    </div>
                </a>
                ...
                <a href="{{ route('pengelola')}}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Tambah Pengelola</span>
                    </div>
                </a>
                <a href="{{ route('memberadmin') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Tambah Player</span>
                    </div>
                </a>
                <a href="{{ route('adminbooking') }}">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">Report Recapt</span>
                    </div>
                </a>
                {{-- <a href="#">
                    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-200 cursor-pointer hover:bg-yellow-500 text-white">
                        <i class="bi bi-bookmark-fill"></i>
                        <span class="text-[15px] ml-4 text-gray-200 font-bold">CRUD Member</span>
                    </div>
                </a> --}}
