...
<head>
    ...
    <title>Tambahkan Pengelola</title>
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="{{ route('register.save.admin') }}" method="POST" class="space-y-4 md:space-y-6">
                        @csrf
                        <div>
                        ...
                        <button type="submit" class="flex w-full justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-yellow-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Simpan Akun Pengelola</button>
                        ...
                        {{-- <a href="/pengelola" class="btn btn-info">Informasi Pegelola</a> --}}
                    </form>
                </div>
            </div>
        </div>
