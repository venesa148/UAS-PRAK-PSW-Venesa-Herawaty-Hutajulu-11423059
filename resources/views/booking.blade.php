...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
            ...
            <a href="/tambahdata" class="btn btn-success">Pesan Lapangan + </a>
        <div class="row">
            ...
            <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Harga 55.000 - 165.000</th>
                    <th scope="col">No.telp</th>
                    <th scope="col">Aksi Pemesanan</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="/deletebook/{{$row->id}}" class="btn btn-danger">Batalkan</a>
